(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("leaflet"), require("react-leaflet"), require("leaflet-draw"));
	else if(typeof define === 'function' && define.amd)
		define(["leaflet", "react-leaflet", "leaflet-draw"], factory);
	else if(typeof exports === 'object')
		exports["ReactLeaflet"] = factory(require("leaflet"), require("react-leaflet"), require("leaflet-draw"));
	else
		root["ReactLeaflet"] = factory(root["L"], root[undefined], root["L"]);
...
var external_amd_leaflet_draw_commonjs_leaflet_draw_commonjs2_leaflet_draw_root_L_ = __webpack_require__(5);
...
/* harmony default export */ var _SetCache = (castArray);
...
/* harmony default export */ var _baseIndexOf = (strictIndexOf);
...
/* harmony default export */ var _cacheHas = (arrayIncludes);
 ...
 * // => true
 */
function _equalByTag_eq(value, other) {
  return value === other || (value !== value && other !== other);
}

/* harmony default export */ var _equalByTag = (_equalByTag_eq);
...
/* harmony default export */ var _getAllKeys = (nativeKeys);
 ...
 * of values.
 */
var nativeObjectToString = _getTag_objectProto.toString;
...
/* harmony default export */ var _getTag = (objectToString);
...
/* harmony default export */ var isBuffer = (stubFalse);
...
var external_amd_react_leaflet_commonjs_react_leaflet_commonjs2_react_leaflet_ = __webpack_require__(2);
...
function (_MapControl) {
  ...
  function EditControl() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onDeleted", function (e) {
      var onDeleted = _this.props.onDeleted;
      if (typeof onDeleted === "function") onDeleted(e);
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onDeleteStart", function (e) {
      var onDeleteStart = _this.props.onDeleteStart;
      if (typeof onDeleteStart === "function") onDeleteStart(e);
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onDeleteStop", function (e) {
      var onDeleteStop = _this.props.onDeleteStop;
      if (typeof onDeleteStop === "function") onDeleteStop(e);
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onDrawStart", function (e) {
      var onDrawStart = _this.props.onDrawStart;
      if (typeof onDrawStart === "function") onDrawStart(e);
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onDrawStop", function (e) {
  ...
  _createClass(EditControl, [{
    ...
    value: function componentDidMount() {
      ...
      map.on(external_amd_leaflet_commonjs_leaflet_commonjs2_leaflet_root_L_default.a.Draw.Event.CREATED, this.onDrawCreate);
      map.on(external_amd_leaflet_commonjs_leaflet_commonjs2_leaflet_root_L_default.a.Draw.Event.DELETED, this.onDeleted);
      map.on(external_amd_leaflet_commonjs_leaflet_commonjs2_leaflet_root_L_default.a.Draw.Event.DELETESTART, this.onDeleteStart);
      map.on(external_amd_leaflet_commonjs_leaflet_commonjs2_leaflet_root_L_default.a.Draw.Event.DELETESTOP, this.onDeleteStop);
      map.on(external_amd_leaflet_commonjs_leaflet_commonjs2_leaflet_root_L_default.a.Draw.Event.DRAWSTART, this.onDrawStart);
      map.on(external_amd_leaflet_commonjs_leaflet_commonjs2_leaflet_root_L_default.a.Draw.Event.DRAWSTOP, this.onDrawStop);
    ...
    value: function componentWillUnmount() {
      ...
      var map = this.props.leaflet.map;
      map.off(external_amd_leaflet_commonjs_leaflet_commonjs2_leaflet_root_L_default.a.Draw.Event.CREATED, this.onDrawCreate);
      map.off(external_amd_leaflet_commonjs_leaflet_commonjs2_leaflet_root_L_default.a.Draw.Event.DELETED, this.onDeleted);
      map.off(external_amd_leaflet_commonjs_leaflet_commonjs2_leaflet_root_L_default.a.Draw.Event.DELETESTART, this.onDeleteStart);
      map.off(external_amd_leaflet_commonjs_leaflet_commonjs2_leaflet_root_L_default.a.Draw.Event.DELETESTOP, this.onDeleteStop);
      map.off(external_amd_leaflet_commonjs_leaflet_commonjs2_leaflet_root_L_default.a.Draw.Event.DRAWSTART, this.onDrawStart);
      map.off(external_amd_leaflet_commonjs_leaflet_commonjs2_leaflet_root_L_default.a.Draw.Event.DRAWSTOP, this.onDrawStop);
    ...
    value: function componentDidUpdate(prevProps) {
      ...
      if (lodash_es_isEqual(this.props.draw, prevProps.draw) || this.props.position !== prevProps.position) {
        return false;
      }
...
_defineProperty(EditControl_EditControl, "propTypes", _objectSpread({}, Object.keys(eventHandlers).reduce(function (acc, val) {
  ...
  onDeleted: prop_types["PropTypes"].func,
